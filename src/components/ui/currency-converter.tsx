...
export default function CurrencyConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-fuchsia-300 to-blue-50">
      <Card className="w-full max-w-md p-6 space-y-4">
        <CardHeader className="text-center">
          <u><CardTitle className="text-2xl font-bold text-blue-800 ">
            Currency Converter
          </CardTitle></u>
         <b> <CardDescription>
      ...
      <br></br>  <div className="text-center text-violet-950 font-bold">
